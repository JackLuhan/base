package cn.houyi.base.common.utils;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    @Value("${base.qiniu.accessKey}")
    private String accessKey;

    @Value("${base.qiniu.secretKey}")
    private String secretKey;

    @Value("${base.qiniu.bucket}")
    private String bucket;

    @Value("${base.qiniu.domain}")
    private String domain;

    @Value("${base.qiniu.zone}")
    ...
    public String qiniuUpload(String filePath, String key) {
        ...
        try {
            ...
            throw new GloabException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String qiniuBase64Upload(String data64) {
        ...
        try {
            ...
            throw new GloabException("上传文件出错，请检查七牛云配置，" + e.toString());
        }
        return domain + "/" + key;
    }
