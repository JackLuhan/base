package cn.houyi.base.generator;

import cn.houyi.base.generator.bean.EntityOfEntity;
...
public class Generator {
     ...
     * 建议仅需修改
     */
    private static final String className = "xxxxx";
     ...
     * 建议仅需修改
     */
    private static final String author = "houyi";

    /**
     * 数据库表名前缀
     * 下方请根据需要修改
     */
    private static final String tablePre = "tb_";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.houyi.base.modules.base.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.houyi.base.modules.base.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.houyi.base.modules.base.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.houyi.base.modules.base.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.houyi.base.modules.base.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/cn/houyi/base/generator/template";
