package cn.houyi.base.config.security.jwt;

import cn.houyi.base.common.annotation.SystemLog;
import cn.houyi.base.common.constant.SecurityConstant;
import cn.houyi.base.common.enums.LogType;
import cn.houyi.base.common.utils.IpInfoUtil;
import cn.houyi.base.common.utils.ResponseUtil;
import cn.houyi.base.common.vo.TokenUser;
...
public class AuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        System.out.println( ResponseUtil.resultMap(true,200,"登录成功", token));
    }
}
